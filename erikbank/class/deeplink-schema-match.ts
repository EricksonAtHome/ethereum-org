...
class DeeplinkSchemaMatch {
  static hasSchema(schemaString: string): boolean {
    ...
    return (
      ...
      lowercaseString.startsWith('erikbank:') ||
  ...
  static navigationRouteFor(
    ...
    // Normalize ErikBank deeplinks to the legacy bluewallet scheme for internal handling
    event.url = event.url.replace(/^erikbank:/i, 'bluewallet:');
